...
import (
	...
	"github.com/postmates/grpc-gateway/protoc-gen-grpc-gateway/descriptor"
	gen "github.com/postmates/grpc-gateway/protoc-gen-grpc-gateway/generator"
	options "github.com/postmates/grpc-gateway/third_party/googleapis/google/api"
)
...
func New(reg *descriptor.Registry, useRequestContext bool) gen.Generator {
	...
	for _, pkgpath := range []string{
		...
		"github.com/postmates/grpc-gateway/utilities",
		"github.com/golang/protobuf/proto",
